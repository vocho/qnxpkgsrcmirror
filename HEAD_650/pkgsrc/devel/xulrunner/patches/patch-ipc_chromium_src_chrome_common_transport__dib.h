...
--- ipc/chromium/src/chrome/common/transport_dib.h.orig	2012-04-20 22:03:52.000000000 +0000
...
+#elif defined(OS_WIN) || defined(OS_MACOSX) || defined(OS_BSD) || defined(OS_QNX)
