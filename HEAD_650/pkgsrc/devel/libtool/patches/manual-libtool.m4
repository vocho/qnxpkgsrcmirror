...
+
 hpux10.20* | hpux11*)
   ...
   case $host_cpu in
@@ -3076,6 +3131,17 @@ linux* | k*bsd*-gnu)
   lt_cv_deplibs_check_method=pass_all
   ;;
...
@@ -3256,7 +3322,7 @@ AC_DEFUN([LT_LIB_M],
